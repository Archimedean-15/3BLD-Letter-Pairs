...
letter_pairs_dict = {
    "AB": "Abs", "AC": "AC", "AD": "Ad", "AE": "Algae", "AF": "Afro", "AG": "Alligator", "AH": "Anchor", "AI": "Acai", 
    ...
    "BR": "Bro", "BS": "Bullsh*t", "BT": "Bat (animal)", "BU": "Bus", "BV": "Beaver", "BW": "Bowser", "BSH": "Bush", "CA": "California", 
    ...
    "GK": "Goku", "GL": "Goal", "GM": "Gem", "GN": "Gnome", "GO": "GoGo Squeez", "GP": "Ground Pound", "GCH": "Gucci", "GR": "Grow", 
    "GS": "Gas", "GT": "Goat", "GU": "Gukesh D.", "GV": "Guava", "GW": "Gwen Stefani", "GSH": "Goulash", "HA": "Hair", "HB": "Hamburger", 
    "HC": "Helicopter", "HD": "Head", "HE": "He", "HF": "High Five", "HG": "Hug", "HI": "HI-C", "HJ": "High Jump", "HK": "Hack", 
    ...
    "JF": "Jeff (from FNAF)", "JG": "Jaguar", "JH": "Jackhamer", "JI": "Jimmy (MrBeast)", "JK": "Jack (from English)", "JL": "Jello", 
    ...
    "MC": "Minecraft", "MD": "Maid", "ME": "Me", "MF": "Mafia", "MG": "Mag", "MH": "Mahi Parikh", "MI": "Minion", 
    "MJ": "Michael Jackson", "MK": "Milk", "ML": "Meal", "MN": "Men", "MO": "Mohammed", "MP": "Matpat", 
    "MCH": "Mochi", "MR": "Mario", "MS": "Mouse", "MT": "Mort", "MU": "Mustard", "MV": "Movie", "MW": "Mew", 
    ...
    "CHP": "Chips", "CHR": "Chore", "CHS": "Cheese", "CHT": "Chat", "CHU": "Chewbacca", "CHV": "Chives", 
    ...
    "SSH": "Sushi", "TA": "Tab", "TB": "Telletubbies", "TC": "Tack", "TD": "Toad (mario)", "TE": "Tee", "TF": "Laffy Taffy", 
    ...
    "WN": "Wonton", "WO": "Wolf", "WP": "Whip", "WCH": "Witch", "WR": "War", "WS": "Wasp", "WT": "Water", "WU": "Empress Wu", 
    ...
    "SHM": "Shamrock", "SHN": "Shin", "SHO": "Shaquille O'Neal", "SHP": "Sheep", "SHCH": "Schach", "SHR": "Shore", 
