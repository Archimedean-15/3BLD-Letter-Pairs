...
letter_pairs_dict = {
    ...
    "BR": "Baskin Robbins", "BS": "Bullsh*t", "BT": "Bat (animal)", "BU": "Bus", "BV": "Beaver", "BW": "Bow", "BSH": "Bush", "CA": "California", 
    "CB": "Cab", "CD": "CD", "CE": "Cereal", "CF": "Calf", "CG": "Cog", "CH": "Chris (from MrBeast)", "CI": "City", "CJ": "CJya", 
    "CK": "Cock (animal)", "CL": "Call", "CM": "Cum", "CN": "Can", "CO": "Coca Cola", "CP": "Checkpoint", "CCH": "C**ch", 
    "CR": "Car", "CS": "Caesar", "CT": "Cat", "CU": "C U (waving)", "CV": "Cava", "CW": "Cow", "CSH": "Cash", "DA": "Dagger", 
    "DB": "Dab", "DC": "D*ck", "DE": "Dee Dee (from UCN)", "DF": "Daffodil", "DG": "Dog", "DH": "Dhow", "DI": "Diddy", 
    "DJ": "DJ", "DK": "Donkey Kong", "DL": "Doll", "DM": "Deutsch Mark", "DN": "Daniel", "DO": "Dodo Bird", "DP": "Dude Perfect", 
    ...
    "ER": "ER", "ES": "Essay", "ET": "E.T.", "EU": "Europe", "EV": "Environment", "EW": "Ew!", "ESH": "Eshaan", "FA": "Fat", "FB": "Facebook", 
    ...
    "HC": "Hiccup", "HD": "Head", "HE": "He he he", "HF": "High Five", "HG": "Hug", "HI": "HI-C", "HJ": "High Jump", "HK": "Hong Kong", 
    ...
    "ID": "ID", "IE": "Ireland", "IF": "IFly", "IG": "Igloo", "IH": "IHOP", "IJ": "Ijsje", "IK": "IKEA", "IL": "Ill", "IM": "IM Levy Rozman", 
    ...
    "KS": "Kiss", "KT": "Kat", "KU": "Kung Fu", "KV": "Kyiv", "KW": "Kiwi (fruit)", "KSH": "Jake Kashi", 
    ...
    "SB": "Sabir", "SC": "Scooter", "SD": "Sad", "SE": "See", "SF": "Sunflower", "SG": "Segway", "SH": "Seahawks", 
    "SI": "Sign", "SJ": "Shell jump", "SK": "Ski", "SL": "Seal", "SM": "S'mores", "SN": "Sun", "SO": "Square-One", 
    "SP": "Sap", "SCH": "Sasquatch", "SR": "Sir", "ST": "Street", "SU": "SIUUUU", "SV": "Sieve", "SW": "Subway (food)", 
